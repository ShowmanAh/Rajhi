                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-6">
                                           ...
                                           {!! Form::text('name', old('name'),  ['class'=>'form-control', 'placeholder'=> 'ادخل اسم المنطقه']) !!}
                                           @error('name')
                                    ...
                                    {!! Form::select('city_id', $city->all()->pluck('name','id')->toArray(), old('city_id'),['class'=>'form-control', 'placeholder'=> 'ادخل اسم المدينه']) !!}
                                    @error('city_id')
                                    <span class="text-danger">{{$message}}</span>
