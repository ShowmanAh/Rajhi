                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item  "><a href="{{route('admin.areas.create')}}">اضافه منطقه جديده</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                                           ...
                                           @foreach ($areas as $index => $area)
                                              <tr>
                                                  ...
                                                  <td>
                                                      ...
                                                      <a href="{{ route('admin.areas.destroy', $area->id)}}"  class="btn btn-outline-danger btn-sm box-shadow-3 mr-1 mb-1 delete">Delete</a>
                                                  </td>
                                                </tr>
                                                  @endforeach
