                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item  "><a href="{{route('admin.services.create')}}">اضافه خدمه جديده</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                                           ...
                                           @foreach ($services as $index => $service)
                                              <tr>
                                                  ...
                                                  <td>
                                                      ...
                                                      <a href="{{ route('admin.services.destroy', $service->id)}}"  class="btn btn-outline-danger btn-sm box-shadow-3 mr-1 mb-1 delete">Delete</a>
                                                  </td>
                                                </tr>
                                                  @endforeach
